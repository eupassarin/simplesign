...
public sealed class BrasilCpfCnpjTests
{
    ...
    {
        IcpBrasilChainValidator.IsValidCpf(cpf).Should().BeTrue();
    }
    ...
    {
        IcpBrasilChainValidator.IsValidCpf(cpf).Should().BeFalse();
    }
    ...
    public void IsValidCpf_BadSecondCheckDigit_ReturnsFalse()
    {
        ...
        IcpBrasilChainValidator.IsValidCpf("11144477734").Should().BeFalse();
    }
    ...
    public void IsValidCpf_BoundaryRemainderLessThanTwo_AcceptsDigitZero()
    {
        ...
        IcpBrasilChainValidator.IsValidCpf("00000000191").Should().BeTrue();
    }
    ...
    {
        IcpBrasilChainValidator.IsValidCnpj(cnpj).Should().BeTrue();
    }
    ...
    {
        IcpBrasilChainValidator.IsValidCnpj(cnpj).Should().BeFalse();
    }
    ...
    public void IsValidCnpj_BadFirstCheckDigit_ReturnsFalse()
    {
        ...
        IcpBrasilChainValidator.IsValidCnpj("11444777000171").Should().BeFalse();
    }
    ...
    {
        // flip the last char
        IcpBrasilChainValidator.IsValidCnpj("11444777000162").Should().BeFalse();
    }
}
